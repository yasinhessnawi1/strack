...
const CyberneticGridShader = () => {
  ...
  useEffect(() => {
    ...
    // Orthographic camera covering -1 to 1 range
    ...
    // Call slightly delayed to ensure container has size
  ...
  return (
    <div
      ...
      style={{
        position:      'absolute', // Changed from fixed to absolute to fit parent
        top:           0,
        left:          0,
        width:         '100%',
        height:        '100%',
        zIndex:        -1,
        pointerEvents: 'none',
        opacity:       0.3 // Reducing opacity so text is readable
      }}
